...
namespace Entity_materie.Proxies
{
    ...
    public abstract class usp_ViewCacher_specific_CREATE_autore_SERVICE
    {


        public static int usp_ViewCacher_specific_CREATE_autore(
			string where_tail,
		...
		)
		{
            ...
            cmd.CommandText = "usp_ViewCacher_specific_CREATE_autore";
            //
            ...
            catch (Exception ex)
            {
                ...
                writingSucceeded =
                    LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
                        ex,
                        "eccezione in DataAccess::usp_ViewCacher_specific_CREATE_autore_SERVICE : " + ex.Message,
						0 // verbosity
                );
                //
            }// end catch
