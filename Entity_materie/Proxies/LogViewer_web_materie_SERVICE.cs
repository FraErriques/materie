...
namespace Entity_materie.Proxies
{
    ...
    public abstract class LogViewer_web_materie_SERVICE
    {


        public static System.Data.DataTable LogViewer_web_materie(
			string startDate,
			string endDate		//
		)
		{
            ...
            cmd.CommandText = "LogViewer_web_materie";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::LogViewer_web_materie_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
