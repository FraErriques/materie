...
namespace Entity_materie.Proxies
{
    ...
    public abstract class usp_docMulti_abstract_UPDATE_SERVICE
    {


        public static int usp_docMulti_abstract_UPDATE(
			Int32 id,
			string _abstract,
		...
		)
		{
            ...
            cmd.CommandText = "usp_docMulti_abstract_UPDATE";
            //
            ...
            catch (Exception ex)
            {
                ...
                writingSucceeded =
                    LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
                        ex,
                        "eccezione in DataAccess::usp_docMulti_abstract_UPDATE_SERVICE : " + ex.Message,
						0 // verbosity
                );
                //
            }// end catch
