...
namespace Entity_materie.Proxies
{
    ...
    public abstract class usp_autore_LOAD_SERVICE
    {


        public static System.Data.DataTable usp_autore_LOAD(
			string where_tail		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_autore_LOAD";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_autore_LOAD_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
