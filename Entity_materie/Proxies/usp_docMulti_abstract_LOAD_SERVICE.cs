...
namespace Entity_materie.Proxies
{
    ...
    public abstract class usp_docMulti_abstract_LOAD_SERVICE
    {


        public static System.Data.DataTable usp_docMulti_abstract_LOAD(
			Int32 id		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_docMulti_abstract_LOAD";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_docMulti_abstract_LOAD_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
