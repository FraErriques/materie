...
namespace Entity.Proxies
{
    ...
    public abstract class usp_autore_LOAD_search_SERVICE
    {


        public static System.Data.DataTable usp_autore_LOAD_search(
		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_autore_LOAD_search";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_autore_LOAD_search_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
