...
namespace Entity_materie.Proxies
{
    ...
    public abstract class usp_autore_LOAD_nominativo_SERVICE
    {


        public static System.Data.DataTable usp_autore_LOAD_nominativo(
			Int32 id		//
		)
		{
            //
            ...
            cmd.CommandText = "usp_autore_LOAD_nominativo";
            //
            ...
            catch (Exception ex)
            {
                ...
                LoggingToolsContainerNamespace.LoggingToolsContainer.DecideAndLog(
					ex,
					"eccezione in DataAccess::usp_autore_LOAD_nominativo_SERVICE : " + ex.Message,
                    0 // verbosity
                );
                //
            }// end catch
