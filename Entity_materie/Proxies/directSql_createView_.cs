...
namespace Entity_materie.Proxies
{
    ...
    public abstract class directSql_createView_SERVICE
    {

        public static int directSql_createView_(
            string viewName
        )
        {
            //
            ...
            cmd.CommandText = "create View "
                + Entity_materie.FormatConverters.ViewNameDecorator_SERVICE.ViewNameDecorator( viewName )
                + " as select * from materie.dbo.materia_LOOKUP GO ";
            //
