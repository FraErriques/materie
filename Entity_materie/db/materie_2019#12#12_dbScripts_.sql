USE [materie]
GO
/****** Object:  User [materieUser]    Script Date: 12/12/2019 21:19:47 ******/
...
GO
/****** Object:  Table [dbo].[autore]    Script Date: 12/12/2019 21:19:47 ******/
SET ANSI_NULLS OFF
GO
...
GO
/****** Object:  Table [dbo].[docMulti]    Script Date: 12/12/2019 21:19:47 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[lCrash]    Script Date: 12/12/2019 21:19:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[materia_LOOKUP]    Script Date: 12/12/2019 21:19:47 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[permesso_LOOKUP]    Script Date: 12/12/2019 21:19:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[utente]    Script Date: 12/12/2019 21:19:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[LogViewer_web_materie]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
order by [when] desc
GO
/****** Object:  StoredProcedure [dbo].[LogViewer_win_materie]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_autore_INSERT]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_autore_LOAD]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
exec( @code)
GO
/****** Object:  StoredProcedure [dbo].[usp_autore_LOAD_nominativo]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where
	aut.id = @id
GO
/****** Object:  StoredProcedure [dbo].[usp_autore_LOAD_search]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
order by
	insertion_time desc
GO
/****** Object:  StoredProcedure [dbo].[usp_autore_LOAD_whoWroteOnMateria]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_autore_note_LOAD]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where id = @id
GO
/****** Object:  StoredProcedure [dbo].[usp_autore_note_UPDATE]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as
	...
	where id = @id
GO
/****** Object:  StoredProcedure [dbo].[usp_chiaveDoppia_LOAD]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
order by id
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_abstract_LOAD]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where id = @id
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_abstract_UPDATE]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as
	...
	where id = @id
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_dataMining]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as
	...
	--ready
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_get_sourceName]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_getBlobAtId]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as
	...
	--ready
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_getDobleKey_at_DocId]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
doc.id = @DocId 
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_getId_at_refAutoreId]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_INSERT]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_LOAD_AutoreMateria]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as
 ...
 where 
	...
	and mate.id = @idMateria
GO
/****** Object:  StoredProcedure [dbo].[usp_docMulti_SEARCH_CandidateDocuments]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
exec (@wholeQuery)
GO
/****** Object:  StoredProcedure [dbo].[usp_lCrash_CheckLine]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as
	...
	return @res
GO
/****** Object:  StoredProcedure [dbo].[usp_lCrash_INSERT]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_lCrash_LOADSINGLE]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as
	...
	where id=@id
GO
/****** Object:  StoredProcedure [dbo].[usp_lCrash_UPDATE]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as
	...
	where id=@id
GO
/****** Object:  StoredProcedure [dbo].[usp_materia_LOOKUP_INSERT]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_materia_LOOKUP_LOAD]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_permesso_LOADSINGLE]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_utente_ChangePwd]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
WHERE
	username=@username
GO
/****** Object:  StoredProcedure [dbo].[usp_utente_INSERT]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_utente_LOADDECODEDSINGLE]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_utente_LOADSINGLE]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_generic_DROP]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_generic_LOAD_interval]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_generic_LOAD_length]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_autOnMat_due]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-------------------------------------------------------------------------
	...
	-- ready
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_autOnMat_uno]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-------------------------------------------------------------------------
	...
	-- ready
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_autore]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-------------------------------------------------------------------------
	...
	-- ready
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_documento]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_logLocalhost]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewCacher_specific_CREATE_Primes]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_ViewGetChunk]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-------------------------------------------------------------------------
	...
	-- ready
GO
/****** Object:  StoredProcedure [dbo].[usp_zPrototipo]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where 
	...
	and aut.id = 1
GO
/****** Object:  StoredProcedure [dbo].[usp_zzProtoDoc]    Script Date: 12/12/2019 21:19:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
